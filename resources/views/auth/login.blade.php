        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              <h2 class="text-uppercase text-center mb-3">{{ __('Login') }}</h2>
              ...
              <form method="POST" action="{{ route('login') }}">
                ...
                <div class="d-flex justify-content-center">
                  <button type="submit"
                    class="btn btn-success btn-block btn-lg gradient-custom-4 text-body">{{ __('Login') }}</button>
                ...
                <p class="text-center text-muted mt-4 mb-0">Does not have an account? <a href={{ url('/register') }}
