        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              <h2 class="text-uppercase text-center mb-3">{{ __('Register') }}</h2>
              ...
              <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-outline mb-2">
                  ...
                  <div class="form-outline mb-2">
                    <input type="text" id="matric_no" class="form-control form-control-lg @error('matric_no') is-invalid @enderror" name="matric_no" value="{{ old('matric_no') }}" required autocomplete="name" autofocus />
                    <label class="form-label" for="email">{{ __('Matric Number') }}</label>
                      @error('matric_no')
                          <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                          </span>
                ...
                <p class="text-center text-muted mt-4 mb-0">Already have an account? <a href={{ url('/login') }}
